 ...
 */
import com.sales.controller.Action_Listener;
...
public class InvoiceFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(243, 242, 246));
 ...
 */
    ...
    private Action_Listener controller = new Action_Listener(this);
    private InvoTable_Model invoicesTableModel;
    
    

    public ArrayList<InvoHeader> get_Invo() {
        if (invoices == null) invoices = new ArrayList<>();
        return invoices;
    }

    public void set_Invo(ArrayList<InvoHeader> invoices) {
        this.invoices = invoices;
    }
    
     public InvoTable_Model get_Invo_Table_Model() {
         if (invoicesTableModel == null) {
            invoicesTableModel = new InvoTable_Model(get_Invo());
        }
        return invoicesTableModel;
    }

    public void set_Invo_Table_Model(InvoTable_Model invoicesTableModel) {
        this.invoicesTableModel = invoicesTableModel;
    }

    public JLabel get_Customer_Name_Label() {
        return customerNameLabel;
    }
    
        public JLabel get_Invoice_Date_Labell() {
        return InvoiceDateLabel;
    }

    public JLabel get_Invo_Numb_Label() {
        return invoiceNumLabel;
    }

    public JTable get_Invo_Table() {
        return invoiceTable;
    }

    public JLabel get_Invo_Total_Label() {
        return invoiceTotalLabel;
    }

    public JTable getLine_Tablee() {
        return lineTable;
    }

    public Action_Listener getController() {
        return controller;
    }
    
     public int getNextInvo_Num() {
        int num = 0;
        
        for (InvoHeader invoice : get_Invo()) {
